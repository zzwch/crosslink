...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#library(crosslink)}

\KeywordTok{load}\NormalTok{(}\StringTok{"data/demo.RData"}\NormalTok{)}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-5-2.pdf}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-5-3.pdf}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-5-4.pdf}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-5-5.pdf}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-5-6.pdf}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-5-7.pdf}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-8-2.pdf}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-8-3.pdf}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-8-4.pdf}
...
\NormalTok{ann.data <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{F=}\KeywordTok{factor}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{"F"}\NormalTok{,}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{6}\NormalTok{)),}\DataTypeTok{levels=}\KeywordTok{paste0}\NormalTok{(}\StringTok{"F"}\NormalTok{,}\KeywordTok{c}\NormalTok{(}\DecValTok{6}\OperatorTok{:}\DecValTok{1}\NormalTok{))),}\DataTypeTok{value=}\KeywordTok{c}\NormalTok{(}\DecValTok{6}\OperatorTok{:}\DecValTok{1}\NormalTok{))}
...
\NormalTok{cl <-}\StringTok{ }\KeywordTok{crosslink}\NormalTok{(nodes,edges,}\DataTypeTok{cross.by=}\StringTok{"type"}\NormalTok{)}
...
\StringTok{  }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{fill =} \StringTok{"#E7298A"}\NormalTok{,}
           ...
           \DataTypeTok{width =} \FloatTok{0.5}\NormalTok{) }\OperatorTok{+}\StringTok{ }\CommentTok{# 间距跟bar同宽}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-16-3.pdf}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-16-4.pdf}
...
\includegraphics{ReadMe_files/figure-latex/unnamed-chunk-16-5.pdf}
